...
router = APIRouter(prefix="/api/v1/issue-tracking", tags=["Issue Tracking"])
...
@router.get("/changes/{change_id}/issues")
...
@router.get("/compliance/user/{username}")
...
@router.get("/issues/{provider}/{issue_id}/changes")
