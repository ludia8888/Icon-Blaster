...
from core.audit.audit_event_publisher import publish_audit_event
    ...
    async def publish(self, context: DiffContext) -> None:
        ...
        try:
            ...
            audit_event = {
                ...
                "resource_id": context.meta.commit_id or "unknown",
                "user_id": context.meta.author.split("@")[0],
                "details": {
                    "branch": context.meta.branch,
                    "database": context.meta.database,
                    "commit_msg": context.meta.commit_msg,
            ...
            # Use existing audit publisher
            await publish_audit_event(audit_event)
