...
async def start_replay(
    ...
    """Start replaying events from a specific point in time"""
...
async def get_replay_status(
    ...
    """Get the status of an ongoing or completed replay operation"""
...
async def generate_test_events(
    ...
    """Generate test events for a consumer (for development/testing)"""
    consumer = await get_schema_consumer()
