...
async def get_shadow_status(
    ...
    """Get detailed status of a single shadow index"""
    shadow_manager = get_shadow_manager()
...
async def list_shadow_indexes(
    ...
    """List all shadow indexes, with optional filters"""
    shadow_manager = get_shadow_manager()
...
async def cancel_shadow_build(
    ...
    """Cancel and cleanup a shadow index build (ADMIN only)"""
    shadow_manager = get_shadow_manager()
...
async def get_shadow_dashboard(
    ...
    """Get dashboard data for shadow index management"""
    shadow_manager = get_shadow_manager()
