"""Basic unit tests for TerminusDBClient - Data persistence layer functionality."""
...
class TestTerminusDBClientBasics:
    """Test suite for TerminusDBClient basic functionality."""
    ...
    def setup_method(self):
        ...
        self.client = TerminusDBClient(
            ...
            use_connection_pool=False  # Disable connection pool for testing
        )
    ...
    def test_terminus_client_initialization(self):
        ...
        assert self.client.use_connection_pool is False  # Disabled for testing
    ...
    def test_terminus_client_default_values(self):
        ...
        default_client = TerminusDBClient(use_connection_pool=False)
        ...
        assert default_client.use_connection_pool is False
    ...
    def test_connection_pool_configuration(self):
        ...
        assert hasattr(self.client, 'use_connection_pool')
        assert hasattr(self.client, 'pool_config')
        
        # Test with connection pool disabled
        no_pool_client = TerminusDBClient(use_connection_pool=False)
        assert no_pool_client.use_connection_pool is False
