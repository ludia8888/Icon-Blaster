...
class UnifiedDatabaseClient(TerminusPort):
    """
    ...
    async def close(self):
        """Close all configured backend connections"""
        async with self._lock:
            ...
            # TerminusDB client does not have an async close method
...
async def get_unified_database_client() -> UnifiedDatabaseClient:
    """Get singleton instance of the unified database client"""
