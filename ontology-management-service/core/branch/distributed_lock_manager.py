...
DEPRECATED: This implementation has known deadlock issues.
Please use RedisLockManager with DistributedLockAdapter instead.

Known issues:
1. Nested lock acquisition can cause deadlocks
2. Transaction-scoped advisory locks can be released unexpectedly
3. No lock hierarchy enforcement
4. Limited deadlock detection and recovery

See: core/branch/redis_lock_manager.py for the recommended implementation.
"""
import asyncio
import hashlib
