...
# Use common_security for hashing
from common_security import hash_data
...
class PolicyIntegrityChecker:
    ...
    def create_snapshot(
        ...
        content_hash = hash_data(policy_json.encode())
        ...
        metadata_hash = hash_data(metadata_json.encode())
        ...
        if signed_policy:
            ...
            signature_hash = hash_data(signature_data.encode())
        ...
        snapshot_hash = hash_data(snapshot_json.encode())
